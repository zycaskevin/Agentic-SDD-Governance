...
Gate with `237` total tests (`236` passed and one platform-dependent skip), and
governance source validation Green. No shared installation, release, merge, or
consumer runtime mutation was performed.
