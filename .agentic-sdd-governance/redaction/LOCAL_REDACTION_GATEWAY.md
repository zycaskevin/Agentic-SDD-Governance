...
14. Mask absolute local user and temporary paths across Linux, macOS, Windows, and WSL representations. This includes WSL-mounted Windows homes, `//wsl.localhost/...`, native `\\wsl.localhost\...`, and legacy `\\wsl$\...` UNC paths; quoted values, spaces, and streaming chunk boundaries do not relax the rule.
