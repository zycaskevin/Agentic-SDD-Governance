...
Revert the bounded Merge commit. Do not delete local raw DEP evidence; retain it for investigation. Consumers remain on the experimental.7 pre-release until a corrected candidate is independently reviewed.
