...
1. Declare an incident ID, commander, affected trust domain, exact Production impact, and time-bounded emergency authority. Use two-person control for regulated, patient/customer-data, payment, or key compromise incidents.
