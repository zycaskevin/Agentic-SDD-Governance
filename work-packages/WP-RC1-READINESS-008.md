...
- Evidence: `DEP-RC1-REVIEW-FIX-R11-019` (authoritative); `DEP-RC1-REVIEW-FIX-R10-018`, `DEP-RC1-REVIEW-FIX-R9-017`, `DEP-RC1-REVIEW-FIX-R8-016`, `DEP-RC1-REVIEW-FIX-R7-015`, `DEP-RC1-REVIEW-FIX-R6-014`, and `DEP-RC1-REVIEW-FIX-R5-013` are predecessor packages.
...
- Complete and strictly verify `DEP-RC1-REVIEW-FIX-R11-019`; generate a local PR attachment block only from redacted shareable artifacts. R11 records the exact PR #32 review, GraphQL thread IDs, and `discussion_r...` URLs; R10 through R5 remain predecessor evidence rather than current authority. A collector UUID or redacted numeric review suffix is not used as GitHub identity.
