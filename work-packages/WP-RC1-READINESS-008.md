...
- Evidence: `DEP-RC1-REVIEW-FIX-R13-021` (authoritative); `DEP-RC1-REVIEW-FIX-R12-020`, `DEP-RC1-REVIEW-FIX-R11-019`, `DEP-RC1-REVIEW-FIX-R10-018`, `DEP-RC1-REVIEW-FIX-R9-017`, `DEP-RC1-REVIEW-FIX-R8-016`, `DEP-RC1-REVIEW-FIX-R7-015`, `DEP-RC1-REVIEW-FIX-R6-014`, and `DEP-RC1-REVIEW-FIX-R5-013` are predecessor packages.
...
- Complete and strictly verify `DEP-RC1-REVIEW-FIX-R13-021`; generate a local PR attachment block only from redacted shareable artifacts. R13 records the independent PR #34 review that rejected the rollback topology and isolated release-test environment; R12 records the exact PR #33 review and remains predecessor evidence together with R11 through R5. A collector UUID or redacted numeric review suffix is not used as GitHub identity.
