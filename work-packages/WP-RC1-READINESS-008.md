...
- Issue: user-authorized Codex task objective dated 2026-08-21; create the matching GitHub Issue when repository authentication is restored
...
- Evidence: `DEP-RC1-READINESS-008`
...
- Complete and strictly verify `DEP-RC1-READINESS-008`; generate a local PR attachment block only from redacted shareable artifacts.
