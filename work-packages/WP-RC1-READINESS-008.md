...
- Evidence: `DEP-RC1-REVIEW-FIX-R12-020` (authoritative); `DEP-RC1-REVIEW-FIX-R11-019`, `DEP-RC1-REVIEW-FIX-R10-018`, `DEP-RC1-REVIEW-FIX-R9-017`, `DEP-RC1-REVIEW-FIX-R8-016`, `DEP-RC1-REVIEW-FIX-R7-015`, `DEP-RC1-REVIEW-FIX-R6-014`, and `DEP-RC1-REVIEW-FIX-R5-013` are predecessor packages.
...
- Complete and strictly verify `DEP-RC1-REVIEW-FIX-R12-020`; generate a local PR attachment block only from redacted shareable artifacts. R12 records the exact PR #33 review, GraphQL thread IDs, REST inline-comment IDs, and GitHub review URL; R11 through R5 remain predecessor evidence rather than current authority. A collector UUID or redacted numeric review suffix is not used as GitHub identity.
