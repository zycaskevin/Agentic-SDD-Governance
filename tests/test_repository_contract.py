...
class RepositoryContractTests(unittest.TestCase):
    ...
    def test_rc1_work_package_and_rollback_bind_current_proof(self):
        ...
        self.assertIn(
            "- Evidence: `DEP-RC1-REVIEW-FIX-R15-023` (authoritative)",
            work_package,
        )
        self.assertIn(
            "Complete and strictly verify `DEP-RC1-REVIEW-FIX-R15-023`",
            work_package,
        )
        rollback = (
    ...
    def test_native_broker_rehearsal_runs_real_linux_and_macos_sockets(self):
        ...
        self.assertIn("python -m unittest tests.test_broker_native -v", workflow)
