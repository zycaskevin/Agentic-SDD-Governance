...
class RepositoryContractTests(unittest.TestCase):
    def test_coderabbit_reviews_product_and_current_evidence_under_file_limit(self):
        ...
        self.assertNotIn("!evidence/DEP-RC1-REVIEW-FIX-R20-028/**", filters)
    ...
    def test_rc1_work_package_and_rollback_bind_current_proof(self):
        ...
        self.assertIn(
            "- Evidence: `DEP-RC1-REVIEW-FIX-R20-028` (authoritative)",
            work_package,
        )
        self.assertIn(
            "Complete and strictly verify `DEP-RC1-REVIEW-FIX-R20-028` at L1",
            work_package,
        )
        self.assertIn(
