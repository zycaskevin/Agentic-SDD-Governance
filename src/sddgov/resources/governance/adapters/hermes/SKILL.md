...
description: Apply approved SDD scope, L0-L3 authority, evidence-driven debugging, local redaction, and bounded owner escalation to Hermes Agent software development and debugging tasks.
---
