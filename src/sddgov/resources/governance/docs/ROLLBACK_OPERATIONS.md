...
3. After that commit, change only Evidence, the Merge gate, and review receipts. Any later product/code/config change requires a new implementation commit and a new rollback proof/review.
