...
12. Collector/redaction updates are transactional at the DEP boundary: a failed control write removes only artifacts written by that operation and restores the prior control snapshot without overwriting a later writer. Pending attachment staging is a strict-verification error and must be recovered or removed locally before Proof.
