...
The canonical machine document is `summary.yaml`, encoded as JSON-compatible YAML so the stdlib CLI can parse it without an optional YAML dependency. It conforms to `schemas/debug-evidence-package.schema.json`.
